...
export const categorias: Categoria[] = [
  ...
  // },
  {
    ...
    objetivos: {
      Defensa: {
        Individual: [
          { nombre: "Desplazamiento defensivo en espejo", url: "https://www.youtube.com/watch?v=IBB9dsczLHc" },
          ...
          { nombre: "Desplazamiento defensivo + recupero (competencia)", url: "" },
          { nombre: "Desplazamiento defensivo + salto lateral", url: "https://www.youtube.com/watch?v=Te89QbBwdBI" },
          { nombre: "Desplazamiento defensivo (1x1) con ayuda del atacante", url: "https://www.youtube.com/watch?v=1z6Tze7jDcM" },
        ],
      },
      Dribbling: {
        Estático: [
      ...
      Táctico: {
        Ataque: [
          { nombre: "1 pelota", url: "https://www.youtube.com/watch?v=UTVUuXsvWT8" },
          { nombre: "2 pelotas", url: "https://www.youtube.com/watch?v=UTVUuXsvWT8",},
          { nombre: "Adentro y afuera", url: "https://www.youtube.com/watch?v=UTVUuXsvWT8" },
          { nombre: "Atras y adelante", url: "https://www.youtube.com/watch?v=UTVUuXsvWT8" },
        ],
        Defensa: [
      ...
      "Movimiento de pies": {
        Ataque: [
          ...
          { nombre: "Detención 1 y 2 tiempos después de dribbling + pivoteo", url: "" },
    ...
    objetivos: {
      Defensa: {
        Individual: [
          ...
          { nombre: "Desplazamiento defensivo + salto lateral", url: "https://www.youtube.com/watch?v=Te89QbBwdBI" },
          { nombre: "Desplazamiento defensivo (1x1) con ayuda del atacante", url: "https://www.youtube.com/watch?v=1z6Tze7jDcM" },
          { nombre: "Línea de pase a 45 (1x1)", url: "https://www.youtube.com/watch?v=eev9CfjnKeI" },
          { nombre: "1vs1 con ayuda (juego)", url: "" },
          { nombre: "Rebote - Box Out", url: "" },
          { nombre: "Reacción a la pelota de tenis", url: "https://www.youtube.com/watch?v=jApgipUdo40" },
          { nombre: "Desplazamiento + repiqueteo + ayuda", url: "https://www.youtube.com/watch?v=DMNXkdkqKnI" },
          { nombre: "Close out + desplazamiento + sprint", url: "https://www.youtube.com/watch?v=0zzqgAFb5Tg" },
          { nombre: "Desplazamiento + sprint + recupero", url: "https://www.youtube.com/watch?v=Fs9BDjc8-Zo" },
          { nombre: "4x4 'change!", url: "https://www.youtube.com/watch?v=QKX7TrtsyxM" },
      ...
      Pase: {
        "1 pelota": [
          ...
          { nombre: "Pase en desplazamiento (2 calles)", url: "" },
          { nombre: "Pase en desplazamiento con oposición (2 calles)", url: "" },
          { nombre: "Pase con receptor + correr (juego)", url: "" },
          { nombre: "Pases estáticos", url: "" },
          { nombre: "Recepción", url: "" },
    ...
    objetivos: {
      Defensa: {
        Individual: [
          ...
          { nombre: "Close out + desplazamiento + sprint", url: "https://www.youtube.com/watch?v=0zzqgAFb5Tg" },
          { nombre: "Desplazamiento + sprint + recupero", url: "https://www.youtube.com/watch?v=Fs9BDjc8-Zo" },
          { nombre: "1x1 ayuda + recupero", url: "https://www.youtube.com/watch?v=YCeyF7kJj6w" },
          { nombre: "3x3 ayuda + recupero (media cancha)", url: "" },
          { nombre: "4x4 'change!", url: "https://www.youtube.com/watch?v=QKX7TrtsyxM" },
          { nombre: "Close out", url: "https://www.youtube.com/watch?v=Q1MtSBnWBpU" },
          { nombre: "Repiqueteo + close out", url: "https://www.youtube.com/watch?v=S2UWvLEVLo0" },
          { nombre: "Close out + línea de pase + 1x1", url: "https://www.youtube.com/watch?v=yHt935lRyoQ" },
          { nombre: "2x2 a 45 con coach driblando", url: "https://www.youtube.com/watch?v=M8zmrlSTo78" },
    ...
    objetivos: {
      Defensa: {
        Individual: [
          ...
          { nombre: "Close out + línea de pase + 1x1", url: "https://www.youtube.com/watch?v=yHt935lRyoQ" },
          { nombre: "2x2 a 45 con coach driblando", url: "https://www.youtube.com/watch?v=M8zmrlSTo78" },
          { nombre: "4x4 saltar a la pelota - posicional", url: "https://www.youtube.com/watch?v=J7_vIDIoDOs" },
          { nombre: "4x4 ataque pasa a defensa", url: "https://www.youtube.com/watch?v=4_WG_heI1Xg" },
          { nombre: "Ayuda + recupero + close out", url: "https://www.youtube.com/watch?v=jSRdBtZwydM" },
          { nombre: "línea de pase + perder + recupero", url: "https://www.youtube.com/watch?v=AJLwJMnvffg" },
          { nombre: "3 calles, ayuda + linea de pase", url: "https://www.youtube.com/watch?v=mJFHWYTL9Ng" },
        ],
      },
      Dribbling: {
        Estático: [
      ...
      "1 vs 1": {
        "Media cancha": [
          ...
          { nombre: "Mano en mano + definición", url: "https://www.youtube.com/watch?v=7wl97N2eBwI" },
          { nombre: "Definición con ayuda defensiva", url: "https://www.youtube.com/watch?v=9DjWr8SEOkc" },
          { nombre: "1x1 a 45 con ayuda", url: "https://www.youtube.com/watch?v=TbDvnwinwR8" },
          { nombre: "1x1 ayuda + recupración + close out", url: "https://www.youtube.com/watch?v=8qz8z1s-8o0" },
        ],
        "Toda la cancha": [
          { nombre: "Toda la cancha", url: "https://www.youtube.com/watch?v=XXbPN2Lu9Zc" },
          { nombre: "Toda la cancha a la carrera", url: "https://www.youtube.com/watch?v=ARzODZqMDfI" },
...
export const videos_modelo = [
  {
    objetivos: {
      ...
      Lanzamiento: [
        { nombre: "A pie firme", url: "https://www.youtube.com/watch?v=U27TmzoXlCs" },
        { nombre: "Terminación de tiro", url: "https://www.youtube.com/watch?v=s4bSJATNEIs" },
        { nombre: "Detención en 2 tiempos", url: "https://www.youtube.com/watch?v=P2Gi90G8rt4" },
        { nombre: "Detención en 1 tiempo", url: "https://www.youtube.com/watch?v=prHJdbjRXIw" },
        { nombre: "Step back", url: "https://www.youtube.com/watch?v=bgZQcLpKMcM" },
        { nombre: "Step back con crossover", url: "https://www.youtube.com/watch?v=8seDm7SqT9I" },
        { nombre: "Recibir y tirar (catch & shoot)", url: "https://www.youtube.com/watch?v=8seDm7SqT9I" },
        { nombre: "Step back con crossover", url: "https://www.youtube.com/watch?v=8seDm7SqT9I" },
      ],
      Definiciones: [
        { nombre: "Giro + tiro en potencia", url: "https://www.youtube.com/watch?v=gCuIdCK0MRE" },
        { nombre: "Bandeja", url: "https://www.youtube.com/watch?v=gCuIdCK0MRE" },
        { nombre: "Bandeja a un paso", url: "https://www.youtube.com/watch?v=ERMgg4J8LQs" },
        { nombre: "Flotadora", url: "https://www.youtube.com/watch?v=2OTP0ckodA8" },
        { nombre: "Bandeja pasada por abajo del aro", url: "https://www.youtube.com/watch?v=2St9-ma2CbM" },
        { nombre: "Bandeja a paso cambiado", url: "" },
        { nombre: "Eurostep", url: "https://www.youtube.com/watch?v=dOrnJJnhzO4" },
      ],
      Pase: [
        { nombre: "Con una mano", url: "https://www.youtube.com/watch?v=ToKZEHrpUvc" },
        { nombre: "Con una mano después de dribbling", url: "https://www.youtube.com/watch?v=PbAiF0zbrTg" },
        { nombre: "De revés", url: "https://www.youtube.com/watch?v=CGouIAHFBjg" },
      ],
      Defensa: [
        { nombre: "Desplazamiento defensivo", url: "https://www.youtube.com/watch?v=oI4MFU0oqJE" },
      ],
      "Movimiento de pies": [
        { nombre: "Pivoteo", url: "https://www.youtube.com/watch?v=4e4_4wdh-J4" },
        { nombre: "Triple amenaza", url: "https://www.youtube.com/watch?v=cBw34fdycD8" },
        { nombre: "Finta de penetración", url: "https://www.youtube.com/watch?v=BO2AonrV6MA" },
        { nombre: "Finta de tiro", url: "https://www.youtube.com/watch?v=7UvFgnJr5eI" },
      ],
    },
  },
];
